...
public class UpdateMovie implements Inter {
	@Override
	public void inter(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String mo_open = request.getParameter("mo_type");
		...
		modao.update_movie(mo_code, mo_name, mo_info, mo_post, mo_run, mo_type, mo_open, mo_age, mo_dirname, mo_actname);
