...
<c:forEach var="i" items="${barray}">
    <div class="show-details" onclick="toggleDetails(${i.book_id})">
        ...
        예매번호: ${i.book_id} &nbsp;&nbsp;
        ${i.mo_name}&nbsp; 
        <span class="cancelPrice">${i.price}원</span>
        <div class="state">[ 취소 완료 ]</div>
        <br>
        <div class="details details-${i.book_id}">
           <div class="wave">
			...
			좌석　　	&nbsp&nbsp&nbsp <span class="cancel">예매 취소된 좌석은 조회 불가합니다.</span><br>
			<hr>
			결제 일시 &nbsp&nbsp&nbsp ${i.datetime}
			<hr>
			</div>
			<div >
				총 결제금액 <h2 class="pay"> ${i.price} 원</h2>
			</div>
