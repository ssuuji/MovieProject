...
function MPrice() {
  	...
  	//지도보기 팝업 열기
  	function MapPopup() {
        window.open('../service/Gnmap.jsp', '영화관오시는길', 'width=430,height=500');
  	}  
  	 
    // 주차안내 팝업 열기
    function PkPopup() {
        window.open('../service/GnParking.jsp', '주차안내', 'width=600,height=700');
    }
    // 대중교통 안내
    function BMWPopup() {
    	window.open('../service/GnBMW.jsp','대중교통안내','width=850,height=500');							
	} 
...
<tr>
<td colspan="2">ㆍ서울 서초구 신반포로 176 </td>
</tr>
<tr >
<td colspan="2">
