...
function MPrice() {
  	...
  	//지도보기 팝업 열기
  	function MapPopup() {
        window.open('../service/Ydpmap.jsp', '영화관오시는길', 'width=430,height=500');
  	}  
    // 주차안내 팝업 열기
    function PkPopup() {
        window.open('../service/YdpParking.jsp', '주차안내', 'width=600,height=650');
    }
    // 대중교통 안내
    function BMWPopup() {
    	window.open('../service/YdpBMW.jsp','대중교통안내','width=850,height=450');
    } 
...
<tr>
<td colspan="2">ㆍ서울 영등포구 영중로 15 </td>
</tr>
<tr >
<td colspan="2">
