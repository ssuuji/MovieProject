...
window.onload = function() {
	var joongang1 = new kakao.maps.LatLng(37.504684045653825, 127.00411671938488);
	...
	var markerPosition  = new kakao.maps.LatLng(37.504684045653825, 127.00411671938488); 
    ...
    var infowindow = new kakao.maps.InfoWindow({
        content: '<div style="padding:10px;">주소: 서울 서초구 신반포로 176 </div>'
    });
